...
class HomeViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet weak var container_News: UIView!
    @IBOutlet weak var container_TripPlan: UIView!
    @IBOutlet weak var container_Map: UIView!
    ...
    @IBAction func segmentController(_ sender: UISegmentedControl) {
        ...
        case 2:
            scrollViewController.setContentOffset(CGPoint(x: scrollViewController.bounds.size.width * 2, y: 0), animated: true)
        default:
            break;
        }
    }
