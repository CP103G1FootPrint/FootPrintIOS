...
class HomeTripMapViewController: UIViewController,MKMapViewDelegate {
    var tripMap: Trip!
//    var name:String?
//    var lat:Double?
//    var long:Double?
    ...
    override func viewDidLoad() {
        ...
        setMapRegion()
        //init
        changeDataLandMark(tripMap.tripID!, 0)
...
//        print("trip \(String(describing: tripMap.title))")
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(homeLocationMapUpdated(noti:)), name: notificationName, object: nil)
    }
    ...
    @objc func homeLocationMapUpdated(noti:Notification) {
    ...
    @IBAction func homeUnwindsegueMapController(segue: UIStoryboardSegue) {
        if let controller = segue.source as? HomeTripDetailViewController {
